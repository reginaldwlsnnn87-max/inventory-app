...
`/Users/reggieboi/coding folder/inventory app/inventory app.xcodeproj/Branding/AppIconSource`
...
```bash
bash "/Users/reggieboi/coding folder/inventory app/inventory app.xcodeproj/Branding/install_app_icon.sh"
```
